...
const configuredAuthDomain = (process.env.EXPO_PUBLIC_FIREBASE_AUTH_DOMAIN ?? '').trim().toLowerCase();
const webAuthDomain =
  Platform.OS === 'web' && (configuredAuthDomain === 'ownly.cloud' || configuredAuthDomain === '')
    ? 'ownly-auth.firebaseapp.com'
